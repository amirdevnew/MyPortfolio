...
<body class="bg-black">
    ...
    <div class="myBody">
                ...
                <div class="row text-left leftAl mt-5 pt-5">
                    <div class="col-12">
                        <div class="container-fluid">
                            <div class="row row-gap-3">
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/ngaduapps1.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="NgaduApps">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/ngaduapps2.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="NgaduApps">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/ngaduapps3.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="NgaduApps">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/ngaduapps4.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="NgaduApps">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/ngaduapps5.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="NgaduApps">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/ngaduapps6.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="NgaduApps">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-5 portngaduapps">
                        <div class="row">
                            <div class="col">
                ...
                <div class="row text-left leftAl mt-5 pt-5">
                    <div class="col-12">
                        <div class="container-fluid">
                            <div class="row row-gap-3">
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/logo57_1.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="KADIN 57th Anniversary Logo Design">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/logo57_2.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="KADIN 57th Anniversary Logo Design">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/logo57_3.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="KADIN 57th Anniversary Logo Design">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/logo57_4.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="KADIN 57th Anniversary Logo Design">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/logo57_5.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="KADIN 57th Anniversary Logo Design">
                                </div>
                                <div class="col-6 col-lg-4">
                                    <img class="rounded" src="assets/img/logo57_6.png" width="100%" data-aos="flip-left" data-aos-duration="1000" alt="KADIN 57th Anniversary Logo Design">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-5 portlogo57">
                        <div class="row">
                            <div class="col">
                                <h1 data-aos="zoom-in-right" data-aos-duration="1000" data-aos-delay="500" class="fontAkronim">KADIN Indonesia 57th Anniversary Logo Design</h1>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 colReplace">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="col-4 mx-auto">
                                    <h4 class="testi1">GG Amir, that's awesome!</h4>
                                    <small class="stabilo text-center">Afra, Friend at School</small>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="col-4 mx-auto">
                                    <h4 class="testi2">Amir carried the entire team. Honestly, we wouldn't have made it without him.</h4>
                                    <small class="stabilo text-center">Septi, Friend at School</small>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="col-4 mx-auto">
                                    <h4 class="testi3">You're awesome, Mir. You're a true all-rounder.</h4>
                                    <small class="stabilo text-center">Sandi Hardja, Friend at School</small>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-3 text-center">
                        <a target="_blank" href="https://amirs411.github.io/"><img class="icon2Social" src="assets/img/icon/webku.png" width="75%" alt="Web Link"></a>
                    </div>
                    <div class="col-3 text-center">
                        <a target="_blank" href="https://www.facebook.com/profile.php?id=61552352847064"><img class="icon2Social" src="assets/img/icon/Facebook.png" width="75%" alt="Facebook Link"></a>
                    </div>
                    <div class="col-3 text-center">
                        <a target="_blank" href="https://www.instagram.com/amir_dev_411/"><img class="icon2Social" src="assets/img/icon/Instagram.png" alt="Instagram Link" width="75%"></a>
                    </div>
                    <div class="col-3 text-center">
                        <a target="_blank" href="https://www.linkedin.com/in/amir-dev-6bb758295/"><img class="icon2Social" src="assets/img/icon/LinkedIn.png" alt="Linkedln Link" width="75%"></a>
                    </div>
                </div>

                <div class="row justify-content-center">
                    <div class="col-3 text-center">
                        <a target="_blank" href="https://www.tiktok.com/@amir_dev_411"><img class="icon2Social" src="assets/img/icon/Tiktok.png" alt="TikTok Link" width="75%"></a>
                    </div>
                    <div class="col-3 text-center">
                        <a target="_blank" href="https://x.com/amir_dev_411"><img class="icon2Social" src="assets/img/icon/Twitter.png" alt="X Link" width="70%"></a>
                    </div>
                    <div class="col-3 text-center">
                        <a target="_blank" href="https://github.com/amirdevnew"><img class="icon2Social" src="assets/img/icon/Github.png" alt="Github Link" width="75%"></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="my-5 pt-5">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-sm-3 text-center stabilo">&copy; Copyright <?= date('Y'); ?>. Built with 💖 by Amir.</div>
                </div>
            </div>
        </footer>
